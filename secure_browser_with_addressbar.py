...
class TeleBrowser(QMainWindow):
    ...
    def initUI(self):
        ...
        # Create navigation bar with address bar
        nav_bar = QHBoxLayout()
        ...
        self.home_btn.setFixedSize(40, 30)
        ...
        self.go_btn.setToolTip('Navigate to URL')
        ...
        self.close_btn.setStyleSheet('background-color: #ff4444; color: white; font-weight: bold; font-size: 16px;')
    ...
    def navigate_to_url(self):
        ...
        if not url_text.startswith(('http://', 'https://', 'file://')):
            ...
            if '.' in url_text and ' ' not in url_text:
                ...
                # Treat as search query (you can customize the search engine)
    ...
    def setup_network_monitoring(self):
        ...
        # Connect to network configuration changed signal
    ...
    def close_browser(self):
        """Close the browser"""
        # Set flag to prevent eventFilter from reactivating window
    ...
    def eventFilter(self, obj, event):
        ...
        # Don't interfere if we're in the closing process
        if self.is_closing:
